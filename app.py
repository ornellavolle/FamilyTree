...
UNIONS = {
    ...
    "11-55": {"a": 11, "b": 55, "date": "16/05/1918"},
    "11-57": {"a": 11, "b": 57, "date": "14/07/1926"},
}
...
const ROWS=[
  ...
  {y:40+(ROW_H+ROW_GAP)*3, ids:[5,6,48,7,51,31,32,33,10,21,11,55,56,8,9]},
  {y:40+(ROW_H+ROW_GAP)*4, ids:[50,49,13,12,57,58,59,60,61,62,52,53,54]},
